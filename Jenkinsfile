pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/cairlsr'                                                                    //<------your MiamiID
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/miamioh-cairlsr/225-lab3-7.git'                                    //<------your MiamiID
        KUBECONFIG = credentials('cairlsr-225')                                                         //<------your MiamiID
    }
